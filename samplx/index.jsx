...
import { Play, Square, Upload, Download, Scissors, Trash2 } from 'lucide-react';
...
const SamplX = () => {
  ...
  const exportAllSlices = async () => {
    ...
    const gapSamples = sampleRate;
    let totalLength = slices.reduce((sum, slice) => {
      return sum + Math.floor((slice.end - slice.start) * sampleRate) + gapSamples;
    }, 0);
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-zinc-800 rounded-lg p-4 mb-6">
          ...
          <canvas
            ...
            style={{ cursor: 'url("data:image/svg+xml;utf8,<svg xmlns=\'http://www.w3.org/2000/svg\' width=\'20\' height=\'40\' viewBox=\'0 0 20 40\'><line x1=\'10\' y1=\'0\' x2=\'10\' y2=\'40\' stroke=\'%2300ccff\' stroke-width=\'2\'/><circle cx=\'10\' cy=\'20\' r=\'3\' fill=\'%2300ccff\'/></svg>") 10 20, crosshair' }}
